    ...
    <div class="page-group">
        ...
        <div class="m-block-header" id="div-header">
            ...
            <a href="/" class="m-index-icon"><i class="m-public-icon"></i></a>
                ...
                <!-- 产品信息 -->
                <div class="pro_info">
                    <h2 class="gray6" id="cart" goods_id={{$data->goods_id}}>
                        
                        (第<em id='Period'>{{$data->goods_id}}</em>潮)
                        {{$data->goods_name}}<span>{{$data->goods_text}}</span>
                    </h2>
                    <div class="purchase-txt gray9 clearfix">
                        价值：￥{{$data->market_price}}
                    </div>
                    <div class="clearfix">
                        ...
                        <div class="gRate">
                            <div class="Progress-bar">
                                ...
                                <ul class="Pro-bar-li">
                                    <li class="P-bar01"><em>{{$data->self_price}}</em>已参与</li>
                                    <li class="P-bar02"><em>{{$data->goods_score}}</em>总需人次</li>
                                    <li class="P-bar03"><em>{{$data->goods_num}}</em>剩余</li>
                                </ul>
                            </div>
                        </div>
                    </div>
