...
<div class="wrapper">
    <div class="registerCon">
        <div class="binSuccess5">
            <ul>
                <li class="accAndPwd">
                    ...
                    <dl>
                        <input id="txtPassword" type="password" placeholder="请输入密码密码" maxlength="20" /><b></b>
                    </dl>
                    <dl>
                        <input id="verifcode" type="text" placeholder="请输入您的验证码" maxlength="4" style="width:60%"/><b></b>
                        <img src="{{url('create')}}" alt="" id="img">
                    </dl>
                </li>
            </ul>
        ...
        <div class="forget">
            <a href="#">忘记密码？</a><b></b><a href="register">新用户注册</a>
        </div>
    </div>
