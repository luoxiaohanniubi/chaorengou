        ...
        <div class="registerCon">
            <ul>
                <li class="accAndPwd">
                    ...
                    <dl>
                        <s class="phone"></s><input id="code" style="width:60%" maxlength="11" type="number" placeholder="请输入您验证码" value="" />
                        <button type="button" class="layui-btn layui-btn-warm" id="dateBtn1">获取验证码</button>
                        <span class="clear">x</span>
                    </dl>
                    <dl>
                        <s class="password"></s>
                        <input class="pwd" maxlength="11" id="pass" type="text" placeholder="6-16位数字、字母组成" value="" />
                    ...
                    <dl>
                        <s class="password"></s>
                        <input class="conpwd" maxlength="11" type="text" id="pass2" placeholder="请确认密码" value="" />
                        <input class="conpwd" maxlength="11" type="password2" placeholder="请确认密码" value="" style="display: none" />
                        <span class="mr clear">x</span>
                        <s class="eyeclose"></s>
                    </dl>
                    <dl class="a-set">
