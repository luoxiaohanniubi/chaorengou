        ...
        <div class="all-list-wrapper">
            ...
            <div class="menu-list-wrapper" id="divSortList">
                <ul id="sortListUl" class="list">
                    ...
                    @foreach($res as $k=>$v)
                        <li sortid='100' reletype='1' linkaddr='' class="category" cate_id={{$v->cate_id}}>
                                ...
                                <li id="23468">
                                    ...
                                    <div class="gList_r">
                                        ...
                                        <div class="gRate">
                                            ...
                                            <a codeid="12785750" goods_id={{$v->goods_id}} class="dunp" canbuy="646"><s></s></a>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
